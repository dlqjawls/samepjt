...
def test_get_module_list_success(client, session, create_dummy_modules, admin_token):
    ...
    assert "status_id" in module
    assert "status_name" in module
...
def test_get_module_list_non_admin(client, session, create_dummy_modules, non_admin_token):
...
def test_get_module_list_empty(client, session, admin_token):
...
def test_get_module_list_pagination(client, session, create_dummy_modules, admin_token, clear_modules):
...
def test_get_module_list_invalid_page(client, admin_token):
    # GIVEN: 관리자 토큰 생성
...
def test_get_module_list_invalid_page_size(client, admin_token):
    # GIVEN: 관리자 토큰 생성
...
def test_module_field_conversion(client, session, create_dummy_modules, admin_token, clear_modules):
    ...
    assert module["status_name"] == "active"
